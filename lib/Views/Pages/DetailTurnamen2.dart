...
class DetailTurnamen2 extends StatelessWidget {
  DetailTurnamen2({super.key});
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GetBuilder<TurnamenController>(
                              builder: (_) {
                                if (turC.dataTerdaftar.isNotEmpty) {
                                  return Column(
                                    children: List.generate(
                                        turC.dataTerdaftar.length, (index) {
                                      Pesertaview data =
                                          turC.dataTerdaftar[index];
                                      return ListTile(
                                        leading: const FaIcon(FontAwesomeIcons.users),
                                        title: Text(
                                            "${data.namaPBSI}"),
                                            subtitle: Text(
                                            "${data.nama} & ${data.nama2}"),
                                      );
                                    }),
                                  );
                                }
